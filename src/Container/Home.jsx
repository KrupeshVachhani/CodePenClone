...
const Home = () => {
  ...
  return (
    <>
      <div
        className={`w-1 ${
          isSideMenuOpen ? "w-1" : "flex-[.1] xl:flex -[.1]"
      ...
      >
        ...
        >
          {isSideMenuOpen ? (
            <HiChevronDoubleRight className="text-white text-2xl" />
          ) : (
        ...
        <div className="overflow-hidden w-full flex flex-col gap-4">
          ...
          <Link
            to={"/home"}
            className="object-contain w-full h-auto text-white text-2xl"
          >
          ...
          {/* Start New Project */}
          <Link to={"/NewProject"}>
            <div className="px-6 py-3 flex items-center justify-center text-xs rounded-xl border border-gray-400 cursor-pointer group-hover:border-gray-200 text-white">
              New Project
            </div>
          </Link>
        ...
        <div className="w-full flex items-center justify-between gap-3 px-5 ">
          ...
          <div className="bg-secondary w-full px-4 py-3 rounded-md flex items-center justify-center">
            ...
            <input
              ...
              className="w-full h-6 pl-4 rounded-md bg-secondary focus:outline-none focus:ring-0 focus:none text-primaryText text-xl"
            />
          </div>
          ...
          {!user && (
            ...
            >
              <Link
                to={"/home/auth"}
                className="px-6 py-3 bg-emerald-500 hover:bg-emerald-300 text-white rounded-md text-lg"
              >
                SignUp
              </Link>
            </motion.div>
